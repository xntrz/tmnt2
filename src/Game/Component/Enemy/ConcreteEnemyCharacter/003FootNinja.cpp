...
DEFINE_NEEDED_EFFECTS_FOR(C003FootNinja, { EFFECTID::ID_KO_FLASH });


C003FootNinja::C003FootNinja(void)
: CBaseFootNinjaChr(ENEMYID::ID_FOOT_NINJA_STAFF)
, m_specialityConsider()
{
    ...
    AttachStatusObserver(ENEMYTYPES::STATUS_GUARD,      new CBaseGeneralEnemyChr::CGuardStatusObserver(1.6f));
...
/*virtual*/ C003FootNinja::~C003FootNinja(void)
{
    ;
};