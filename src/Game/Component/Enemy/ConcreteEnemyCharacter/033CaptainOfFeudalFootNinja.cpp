#include "033CaptainOfFeudalFootNinja.hpp"

#include "Game/Component/Enemy/EnemyParameter.hpp"
#include "Game/Component/Enemy/ConcreteAIModerator/BaseFootNinjaAI.hpp"


DEFINE_EMPTY_NEEDED_EFFECTS_FOR(C033CaptainOfFeudalFootNinja);


C033CaptainOfFeudalFootNinja::C033CaptainOfFeudalFootNinja(void)
: CBaseFootNinjaChr(ENEMYID::ID_CAPTAIN_OF_FEUDAL_FOOT_NINJA)
, m_specialityConsider()
{
    ...
    {
        /* FREQUENCY_ATTACK_A               0  */    { 0, 90, 0 },   
        /* FREQUENCY_ATTACK_AA              1  */    { 0, 90, 0 },
        /* FREQUENCY_ATTACK_AAA             2  */    { 0, 90, 0 },
        /* FREQUENCY_ATTACK_B               3  */    { 0, 0,  0 },
        /* FREQUENCY_ATTACK_C               4  */    { 0, 0,  0 },
        /* FREQUENCY_ATTACK_RUN             5  */    { 0, 0,  0 },
        /* FREQUENCY_GUARD_A                6  */    { 0, 90, 0 },
        /* FREQUENCY_GUARD_B                7  */    { 0, 90, 0 },
        /* FREQUENCY_GUARD_SHOT             8  */    { 0, 90, 0 },
        /* FREQUENCY_GUARD_JUMP_ATTACK      9  */    { 0, 90, 0 },
        /* FREQUENCY_GUARD_RUN_ATTACK       10 */    { 0, 90, 0 },
        /* FREQUENCY_GUARD_THROW            11 */    { 0, 90, 0 },
    ...
    AttachStatusObserver(ENEMYTYPES::STATUS_GUARD,      new CBaseGeneralEnemyChr::CGuardStatusObserver(2.4f));
...
/*virtual*/ C033CaptainOfFeudalFootNinja::~C033CaptainOfFeudalFootNinja(void)
{
    ;
};