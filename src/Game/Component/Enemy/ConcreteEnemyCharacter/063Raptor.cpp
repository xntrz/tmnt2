#include "063Raptor.hpp"

#include "Game/Component/Enemy/ConcreteAIModerator/BaseMouserAI.hpp"


C063Raptor::C063Raptor(void)
: CBaseMouserChr(ENEMYID::ID_RAPTOR)
{
...
/*virtual*/ C063Raptor::~C063Raptor(void)
{
    ;
};