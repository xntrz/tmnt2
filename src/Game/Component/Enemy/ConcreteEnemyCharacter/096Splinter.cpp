...
C096Splinter::C096Splinter(void)
: CBaseFootMechSplinter(ENEMYID::ID_SPLINTER)
{
    ...
    uint8 aFreqTable[][GAMETYPES::DIFFICULTY_NUM] =
    {
        ...
        /*          CBaseEliteAI freq           */
        /****************************************/
        /*  FREQUENCY_GUARD                 0   */  {  20,  50,  80 },
        /*  FREQUENCY_ATTACK_HIGH           1   */  {  30,  70, 100 },
        /*  FREQUENCY_ATTACK_AVOID          2   */  {  40,  50,  80 },

        /****************************************/  
        /*          CBaseSplinterAI freq        */  
        /****************************************/  
        /*  FREQUENCY_ATTACK_NORMAL         3   */  {  10,  50,  50 },
        /*  FREQUENCY_ATTACK_NORMALA        4   */  {  10,  30,  60 },
        /*  FREQUENCY_ATTACK_NORMALB        5   */  {  20,  40,  80 },
        /*  FREQUENCY_ATTACK_B              6   */  {  30,  20,  10 },
        /*  FREQUENCY_ATTACK_KICK           7   */  {  20,  60,  80 },
        /*  FREQUENCY_ATTACK_RUN            8   */  {  60,  30,  10 },
        /*  FREQUENCY_ATTACK_B_CHARGE       9   */  {  50,  50,  50 },
        /*  FREQUENCY_ATTACK_THROW         10   */  {  30,  70, 100 },
        /*  FREQUENCY_ATTACK_SHOT          11   */  {  10,  30,  50 },
        /*  FREQUENCY_ATTACK_SHOT_JUMP     12   */  {  20,  50,  80 },
        /*  FREQUENCY_WAIT                 13   */  {  90,  40,  10 },
    };
...
/*virtual*/ C096Splinter::~C096Splinter(void)
{
    ;
};