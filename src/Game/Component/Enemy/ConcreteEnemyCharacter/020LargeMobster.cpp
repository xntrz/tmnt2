#include "020LargeMobster.hpp"

#include "Game/Component/Enemy/EnemyParameter.hpp"


DEFINE_NEEDED_EFFECTS_FOR(C020LargeMobster, { EFFECTID::ID_KO_FLASH });


C020LargeMobster::C020LargeMobster(void)
: CBaseGrapplerEnemyChr(ENEMYID::ID_LARGE_MOBSTER)
...
/*virtual*/ C020LargeMobster::~C020LargeMobster(void)
{
    ;
};