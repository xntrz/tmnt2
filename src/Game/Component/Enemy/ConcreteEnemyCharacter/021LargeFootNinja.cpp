...
DEFINE_NEEDED_EFFECTS_FOR(C021LargeFootNinja, { EFFECTID::ID_KO_FLASH });


C021LargeFootNinja::C021LargeFootNinja(void)
: CBaseGrapplerEnemyChr(ENEMYID::ID_LARGE_FOOT_NINJA)
...
/*virtual*/ C021LargeFootNinja::~C021LargeFootNinja(void)
{
    ;
};