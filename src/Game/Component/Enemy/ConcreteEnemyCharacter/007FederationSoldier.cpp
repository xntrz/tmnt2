#include "007FederationSoldier.hpp"

#include "Game/Component/Enemy/EnemyParameter.hpp"


DEFINE_NEEDED_EFFECTS_FOR(C007FederationSoldier, { EFFECTID::ID_KO_FLASH });


C007FederationSoldier::C007FederationSoldier(void)
: CBaseGrapplerEnemyChr(ENEMYID::ID_FEDERATION_SOLDIER)
, m_specialityConsider()
{
    ...
    parameter.m_feature.m_fWalkMoveSpeed        = 1.6f;
    parameter.m_feature.m_fRunMoveSpeed         = 4.6f;
    ...
    uint8 aFreqTable[][GAMETYPES::DIFFICULTY_NUM] =
    {
        ...
        /* FREQUENCY_ATTACK_RUN             5  */    { 0, 50, 0 },
        /* FREQUENCY_GUARD_A                6  */    { 0, 30, 0 },
        /* FREQUENCY_GUARD_B                7  */    { 0, 30, 0 },
        /* FREQUENCY_GUARD_SHOT             8  */    { 0, 30, 0 },
        /* FREQUENCY_GUARD_JUMP_ATTACK      9  */    { 0, 30, 0 },
        /* FREQUENCY_GUARD_RUN_ATTACK       10 */    { 0, 30, 0 },
        /* FREQUENCY_GUARD_THROW            11 */    { 0, 30, 0 },
    ...
    AttachStatusObserver(ENEMYTYPES::STATUS_GUARD,      new CBaseGeneralEnemyChr::CGuardStatusObserver(0.8f));
...
/*virtual*/ C007FederationSoldier::~C007FederationSoldier(void)
{
    ;
};