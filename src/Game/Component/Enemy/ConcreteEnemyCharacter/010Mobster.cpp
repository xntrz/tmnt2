#include "010Mobster.hpp"

#include "Game/Component/Enemy/EnemyParameter.hpp"


DEFINE_NEEDED_EFFECTS_FOR(C010Mobster, { EFFECTID::ID_KO_FLASH,
                                         EFFECTID::ID_LASER_BEAM_ALL,
                                         EFFECTID::ID_LASER_FIRE_ALL,
                                         EFFECTID::ID_LASER_HIT_ALL });


C010Mobster::C010Mobster(void)
: CBaseGunnerEnemyChr(ENEMYID::ID_MOBSTER)
, m_specialityConsider()
{
    ...
    AttachStatusObserver(ENEMYTYPES::STATUS_TURN,       new CBaseGeneralEnemyChr::CTurnStatusObserver(60.0f, "TurnL", "TurnR"));
...
/*virtual*/ C010Mobster::~C010Mobster(void)
{
    ;
};