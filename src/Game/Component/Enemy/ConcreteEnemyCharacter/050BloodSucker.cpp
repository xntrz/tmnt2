#include "050BloodSucker.hpp"

#include "Game/Component/Enemy/EnemyParameter.hpp"


DEFINE_NEEDED_EFFECTS_FOR(C050BloodSucker, { EFFECTID::ID_KO_SMOKE });


C050BloodSucker::C050BloodSucker(void)
: CBaseBatChr(ENEMYID::ID_BLOOD_SUCKER)
{
...
/*virtual*/ C050BloodSucker::~C050BloodSucker(void)
{
    ;
};