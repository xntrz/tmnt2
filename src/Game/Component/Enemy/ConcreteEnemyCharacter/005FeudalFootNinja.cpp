#include "005FeudalFootNinja.hpp"
...
DEFINE_NEEDED_EFFECTS_FOR(C005FeudalFootNinja, { EFFECTID::ID_KO_FLASH });


C005FeudalFootNinja::C005FeudalFootNinja(void)
: CBaseFootNinjaChr(ENEMYID::ID_FEUDAL_FOOT_NINJA_STAFF)
, m_specialityConsider()
{
    ...
    AttachStatusObserver(ENEMYTYPES::STATUS_GUARD,      new CBaseGeneralEnemyChr::CGuardStatusObserver(1.4f));
...
/*virtual*/ C005FeudalFootNinja::~C005FeudalFootNinja(void)
{
    ;
};