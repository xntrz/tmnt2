#include "036TriceratonShooter.hpp"

#include "Game/Component/Enemy/EnemyParameter.hpp"


DEFINE_NEEDED_EFFECTS_FOR(C036TriceratonShooter, { EFFECTID::ID_KO_FLASH,
                                                   EFFECTID::ID_LASER_BEAM_TRI,
                                                   EFFECTID::ID_LASER_FIRE_TRI,
                                                   EFFECTID::ID_LASER_HIT_TRI });


C036TriceratonShooter::C036TriceratonShooter(void)
: CBaseGunnerEnemyChr(ENEMYID::ID_TRICERATION_SHOOTER)
, m_specialityConsider()
{
    ...
    parameter.m_feature.m_fRotateRate           = 2.8f;
    ...
    parameter.m_AICharacteristic.m_fThinkingFrequency   = 0.15f;
    ...
    AttachStatusObserver(ENEMYTYPES::STATUS_TURN,       new CBaseGeneralEnemyChr::CTurnStatusObserver(45.0f, ENEMYTYPES::MOTIONNAMES::TURNL, ENEMYTYPES::MOTIONNAMES::TURNR));
    ...
    fireParam.magicId       = MAGICID::ID_LASER_BEAM_TRI;
...
/*virtual*/ C036TriceratonShooter::~C036TriceratonShooter(void)
{
    ;
};