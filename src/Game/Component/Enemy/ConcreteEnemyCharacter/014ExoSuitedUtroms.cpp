#include "014ExoSuitedUtroms.hpp"

#include "Game/Component/Enemy/EnemyParameter.hpp"


DEFINE_NEEDED_EFFECTS_FOR(C014ExoSuitedUtroms, { EFFECTID::ID_KO_FLASH,
                                                 EFFECTID::ID_SPARKS,
...
C014ExoSuitedUtroms::C014ExoSuitedUtroms(void)
: CBaseGunnerEnemyChr(ENEMYID::ID_EXO_SUITED_UTROMS)
, m_specialityConsider()
{
    ...
    parameter.m_feature.m_fWalkMoveSpeed        = 1.12f;
    parameter.m_feature.m_fRunMoveSpeed         = 5.6f;
    ...
    AttachStatusObserver(ENEMYTYPES::STATUS_DEATH,      new CBaseGeneralEnemyChr::CDeathMechStatusObserver(1.2f));
...
/*virtual*/ C014ExoSuitedUtroms::~C014ExoSuitedUtroms(void)
{
    ;
};