#include "023LargeFederationSoldier.hpp"

#include "Game/Component/Enemy/EnemyParameter.hpp"


DEFINE_NEEDED_EFFECTS_FOR(C023LargeFederationSoldier, { EFFECTID::ID_KO_FLASH });


C023LargeFederationSoldier::C023LargeFederationSoldier(void)
: CBaseGrapplerEnemyChr(ENEMYID::ID_LARGE_FEDERATION_SOLDIET)
, m_specialityConsider()
{
    ...
    parameter.m_feature.m_fWalkMoveSpeed        = 2.1f;
    parameter.m_feature.m_fRunMoveSpeed         = 5.4f;
    ...
    AttachStatusObserver(ENEMYTYPES::STATUS_WALK_LEFT,  new CBaseGeneralEnemyChr::CSideWalkStatusObserver(1.0f, ENEMYTYPES::MOTIONNAMES::WALKL));
    AttachStatusObserver(ENEMYTYPES::STATUS_WALK_RIGHT, new CBaseGeneralEnemyChr::CSideWalkStatusObserver(1.0f, ENEMYTYPES::MOTIONNAMES::WALKR));
...
/*virtual*/ C023LargeFederationSoldier::~C023LargeFederationSoldier(void)
{
    ;
};