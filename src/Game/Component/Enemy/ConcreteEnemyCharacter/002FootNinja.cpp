...
DEFINE_NEEDED_EFFECTS_FOR(C002FootNinja, { EFFECTID::ID_KO_FLASH });


C002FootNinja::C002FootNinja(void)
: CBaseFootNinjaChr(ENEMYID::ID_FOOT_NINJA_SWORD)
...
/*virtual*/ C002FootNinja::~C002FootNinja(void)
{
    ;
};