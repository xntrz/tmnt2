#include "062KrokodilMouser.hpp"

#include "Game/Component/Enemy/ConcreteAIModerator/BaseMouserAI.hpp"


C062KrokodilMouser::C062KrokodilMouser(void)
: CBaseMouserChr(ENEMYID::ID_KROKODIL_MOUSER)
{
    ...
    parameter.m_AICharacteristic.m_fRadiusOfAction      =  7.0f;
...
/*virtual*/ C062KrokodilMouser::~C062KrokodilMouser(void)
{
    ;
};