...
namespace BASESPIDERMONSTER_AI
{
    ...
    {
        ORDERTYPE_ATTACK_WEB_SHOT = BASEAI6045::ORDERTYPE_ATTACK_EXTEND,
        ORDERTYPE_ATTACK_B,
        ORDERTYPE_ATTACK_C,
        ORDERTYPE_ATTACK_D,        
    };
...
private:
    ...
    {
    public:
        CDecisionUnitAttackCommon(const char* pszUnitName, BASESPIDERMONSTER_AI::ORDERTYPE_ATTACK orderType);
...
public:
    ...
    CBaseSpiderMonsterAI(CEnemyCharacter* pEnemyChr);
    virtual ~CBaseSpiderMonsterAI(void);
