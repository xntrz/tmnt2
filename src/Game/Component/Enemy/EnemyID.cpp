...
{
    { ENEMYID::ID_DUMMY,                        "dummy",                        GAMETEXT_EMPTY,         "",     true    },
    ...
    { ENEMYID::ID_STONE_BITER,                  "STONEBITTER",                  GAMETEXT_ENEMY_040,     "",     true    },
    { ENEMYID::ID_BERGOX,                       "BERGOX",                       GAMETEXT_ENEMY_041,     "",     true    },
    { ENEMYID::ID_SPIDER_MONSTER,               "SPIDER MONSTER",               GAMETEXT_ENEMY_042,     "",     true    },
    { ENEMYID::ID_REDURION,                     "REDURIAN",                     GAMETEXT_ENEMY_043,     "",     true    },
    { ENEMYID::ID_KING_NAIL,                    "KING NAIL",                    GAMETEXT_ENEMY_044,     "",     true    },
    { ENEMYID::ID_GREENPUS,                     "GREENPUS",                     GAMETEXT_ENEMY_045,     "",     true    },
    { ENEMYID::ID_RAZORFIST,                    "RAZORFIST",                    GAMETEXT_ENEMY_046,     "",     true    },
    { ENEMYID::ID_MAD_MUNCHER,                  "MAD MUNCHER",                  GAMETEXT_ENEMY_047,     "",     true    },
    { ENEMYID::ID_RYNOKK,                       "RYNOKK",                       GAMETEXT_ENEMY_048,     "",     true    },
    ...
    { ENEMYID::ID_MOUSER_ROBOT,                 "MOUSER ROBOT",                 GAMETEXT_ENEMY_060,     "",     true    },
    { ENEMYID::ID_MOUSER_ROBOT_B,               "PROTOTYPE MOUSER",             GAMETEXT_ENEMY_061,     "",     true    },
    { ENEMYID::ID_KROKODIL_MOUSER,              "KROKODIL MOUSER",              GAMETEXT_ENEMY_062,     "",     true    },
    { ENEMYID::ID_RAPTOR,                       "RAPTOR",                       GAMETEXT_ENEMY_063,     "",     true    },
    { ENEMYID::ID_CARNIVOROUS_PLANT,            "CARNIVOROUS PLANT",            GAMETEXT_ENEMY_065,     "",     true    },
    { ENEMYID::ID_MURAL_CARNIVOROUS_PLANT,      "MURAL CARNIVOROUS PLANT",      GAMETEXT_ENEMY_066,     "",     true    },
    { ENEMYID::ID_NINJA_RATS_A,                 "NINJA RATS A",                 GAMETEXT_ENEMY_070,     "",     true    },
    { ENEMYID::ID_NINJA_RATS_B,                 "NINJA RATS B",                 GAMETEXT_ENEMY_071,     "",     true    },
    { ENEMYID::ID_NINJA_RATS_C,                 "NINJA RATS C",                 GAMETEXT_ENEMY_072,     "",     true    },
    { ENEMYID::ID_NINJA_RATS_D,                 "NINJA RATS D",                 GAMETEXT_ENEMY_073,     "",     true    },
    { ENEMYID::ID_TRAXIMUS,                     "TRAXIMUS",                     GAMETEXT_ENEMY_074,     "",     true    },
    { ENEMYID::ID_LEATHER_HEAD,                 "LEATHER HEAD",                 GAMETEXT_ENEMY_075,     "",     true    },
    { ENEMYID::ID_ELITE_FOOT_A,                 "ELITE FOOT A",                 GAMETEXT_ENEMY_076,     "",     true    },
    { ENEMYID::ID_ELITE_FOOT_B,                 "ELITE FOOT B",                 GAMETEXT_ENEMY_077,     "",     true    },
    { ENEMYID::ID_ELITE_FOOT_C,                 "ELITE FOOT C",                 GAMETEXT_ENEMY_078,     "",     true    },
    { ENEMYID::ID_ELITE_FOOT_D,                 "ELITE FOOT D",                 GAMETEXT_ENEMY_079,     "",     true    },
    { ENEMYID::ID_ULTIMATE_NINJA,               "ULTIMATE NINJA",               GAMETEXT_ENEMY_080,     "",     true    },
    { ENEMYID::ID_SPASMOSAUR,                   "SPASMOSAUR",                   GAMETEXT_ENEMY_081,     "",     true    },
    { ENEMYID::ID_HUN_A,                        "HUN A",                        GAMETEXT_ENEMY_082,     "",     true    },
    { ENEMYID::ID_HUN_B,                        "HUN B",                        GAMETEXT_ENEMY_083,     "",     true    },
    { ENEMYID::ID_KARAI,                        "KARAI",                        GAMETEXT_ENEMY_084,     "",     true    },
    { ENEMYID::ID_MIYAMOTO_USAGI,               "MIYAMOTO USAGI",               GAMETEXT_ENEMY_085,     "",     true    },
    { ENEMYID::ID_FOOT_MECH_SPLINTER,           "FOOTMECH SPLINTER",            GAMETEXT_ENEMY_086,     "",     true    },
    { ENEMYID::ID_SLASSHUR,                     "SLASSHUR",                     GAMETEXT_ENEMY_087,     "",     true    },
    { ENEMYID::ID_SHREDDER,                     "SHREDDER",                     GAMETEXT_ENEMY_088,     "",     true    },
    { ENEMYID::ID_FEUDAL_JAPAN_SHREDDER,        "FEUDAL JAPAN SHREDDER",        GAMETEXT_ENEMY_089,     "",     true    },
    { ENEMYID::ID_ULTIMATE_SHREDDER,            "ULTIMATE SHREDDER",            GAMETEXT_ENEMY_090,     "",     true    },
    { ENEMYID::ID_DORAKO,                       "DORAKO",                       GAMETEXT_ENEMY_091,     "",     true    },
    { ENEMYID::ID_ELITE_FOOT_DUMMY_A,           "ELITE FOOT DUMMY A",           GAMETEXT_ENEMY_092,     "",     true    },
    { ENEMYID::ID_ELITE_FOOT_DUMMY_B,           "ELITE FOOT DUMMY B",           GAMETEXT_ENEMY_093,     "",     true    },
    { ENEMYID::ID_ELITE_FOOT_DUMMY_C,           "ELITE FOOT DUMMY C",           GAMETEXT_ENEMY_094,     "",     true    },
    { ENEMYID::ID_ELITE_FOOT_DUMMY_D,           "ELITE FOOT DUMMY D",           GAMETEXT_ENEMY_095,     "",     true    },
    { ENEMYID::ID_SPLINTER,                     "SPLINTER",                     GAMETEXT_ENEMY_096,     "",     true    },
