...
public:
    ...
    virtual bool AttachStatusObserver(CStatusObserver* pStatusObserver);
    ...
    ENEMYTYPES::CHARACTERISTIC& AICharacteristic(void) const;
    CStatusSubject& StatusSubject(void) const;
    PARAMETER& CharacterParameter(void) const;
    uint8* FrequencyParameter(void) const;
    CCharacterCompositor& CharacterCompositor(void) const;
