...
static const PASSWORDINFO s_aPasswordList[] =
{
    ...
    { "LDRMRLM", SECRETID::ID_PASSWORD_CHEATCODE_SUPERATTACK,   SECRETID::ID_CHEATCODE_SUPERATTACK,     },
    { "SDLSRLL", SECRETID::ID_PASSWORD_CHEATCODE_SUPERDEFENCE,  SECRETID::ID_CHEATCODE_SUPERDEFENCE,    },
    ...
    { "SRMLDDR", SECRETID::ID_DATABASE_PLAYMATES,               SECRETID::ID_DATABASE_PLAYMATES,        },
};
