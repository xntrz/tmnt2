...
static const AREAINFO s_aNormalAreaInfo[] =
{
    ...
    /*  8 -- ID_AREA10  2-2     */  { GAMETEXT_AREA10_NAME,   GAMETEXT_AREA10_WORLD,      "Lager lab",                "2-2",    2,  STAGEID::ID_ST10N,      1,  ANTIQUEID::ID_AT07,     GAMETIME_HMS(0,  5, 30),  GAMETIME_HMS(0,  5,  0),    },
    ...
    /* 50 -- ID_AREA54  11-3    */  { GAMETEXT_AREA54_NAME,   GAMETEXT_AREA54_WORLD,      "Foot lab",                 "11-3",   0,  STAGEID::ID_ST54F,      2,  ANTIQUEID::ID_AT49,     GAMETIME_HMS(0,  5, 15),  GAMETIME_HMS(0,  8,  0),    },
