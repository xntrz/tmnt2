#include "KeyboardOptionDataWin.hpp"
...
CKeyboardOptionDataWin::CKeyboardOptionDataWin(void)
{
    ;
};
...
void CKeyboardOptionDataWin::Initialize(void)
{
    struct FIXEDINFO
    {
        uint32 m_uDigital;
...
void CKeyboardOptionDataWin::Terminate(void)
{
    ;
};


void CKeyboardOptionDataWin::SetDefault(void)
{
    assignDefaultKey();
};


void CKeyboardOptionDataWin::Apply(void)
{
...
bool CKeyboardOptionDataWin::IsValid(void) const
{
...
void CKeyboardOptionDataWin::Snapshot(RAWDATA& rRawData) const
{
    std::memcpy(rRawData.m_aiKeyAssign, m_aiKeyAssign, sizeof(rRawData.m_aiKeyAssign));
};


void CKeyboardOptionDataWin::Restore(const RAWDATA& rRawData)
{
    std::memcpy(m_aiKeyAssign, rRawData.m_aiKeyAssign, sizeof(m_aiKeyAssign));
};


void CKeyboardOptionDataWin::AssignKey(OPTIONTYPES::KEYFUNC func, int32 iDIKey)
{
    ASSERT(func >= 0);
...
bool CKeyboardOptionDataWin::AssignDownKey(OPTIONTYPES::KEYFUNC func)
{
    ASSERT(func >= 0);
    ASSERT(func < OPTIONTYPES::KEYFUNCMAX);
...
int32 CKeyboardOptionDataWin::GetAssignedKey(OPTIONTYPES::KEYFUNC func) const
{
    ASSERT(func >= 0);
    ASSERT(func < OPTIONTYPES::KEYFUNCMAX);
...
const char* CKeyboardOptionDataWin::GetKeyName(int32 iDIKey) const
{
...
void CKeyboardOptionDataWin::AssignButton(void)
{
...
void CKeyboardOptionDataWin::assignDefaultKey(void)
{
...
void CKeyboardOptionDataWin::assignDefaultButton(void)
{
...
OPTIONTYPES::KEYFUNC CKeyboardOptionDataWin::findFunction(int32 key) const
{
    for (int32 i = 0; i < COUNT_OF(m_aiKeyAssign); ++i)
    {
