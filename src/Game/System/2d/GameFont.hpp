...
public:
    ...
    static void ConvertToMultibyte(char* dst, const wchar* src);
    ...
    static void SetHeight(float fHeight);
    static void SetHeightScaled(float fScale);
    static float GetHeight(void);
    static float GetHeightScaled(void);
