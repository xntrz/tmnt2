...
#define SD_READMODE_HDD         (0)
#define SD_READMODE_CD_DVD      (1)

#define SD_LOADINFO_SYSTEM      (1 << 0)
#define SD_LOADINFO_WAVE        (1 << 1)
#define SD_LOADINFO_TRANS_WAVE  (1 << 2)
#define SD_LOADINFO_COMMAND     (1 << 3)
