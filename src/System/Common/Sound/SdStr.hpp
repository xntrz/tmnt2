...
struct SdStr_t
{
    ...
    float               GainOnPause;
    uint32              DataTotalPlayed;
    uint32              DataTotalSize;
    uint32              DataDurationMS;
    int32               ALBufferCountPrev;
    int32               ALBufferCount;
    int32               ALBufferNoPlaying;
    int32               ALBufferNoReading;
    uint32*             ALBuffer;
    uint32              ALSource;
    int32               WaveTransferRqCount;
    uint32              ALBufferReady[4];
    int32               ALBufferReadyNum;
    uint32              CheckKeyEnd;
};


extern SdStr_t* SdStrSrv[SDSTR_SRV_MAX];
